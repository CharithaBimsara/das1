  ...
  <AdminLayout>
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-xl shadow-card p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Product List</h3>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="product in filteredProducts" :key="product.id" class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">{{ product.companyName }}</div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div class="flex items-center space-x-3">
                    ...
                    <button @click="deleteProduct(product)" class="text-red-600 hover:text-red-900 flex items-center space-x-1" title="Delete Product">
                      <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        <path :d="mdiDelete" />
                      </svg>
                    </button>
...
import { mdiPackageVariant, mdiEye, mdiPencil, mdiDelete, mdiDeskLamp, mdiAccountGroup, mdiChairRolling } from '@mdi/js'
...
const filteredProducts = computed(() => {
  ...
  if (filters.value.company) {
    filtered = filtered.filter(product => product.companyId === filters.value.company)
  }
